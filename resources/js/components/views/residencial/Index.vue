...
<div class="py-1">
    ...
    <div class="row d-flex flex-wrap justify-content-center px-3 px-2-xs">
        <div class="col-md-4 px-4 py-2" v-for="(pack,index) in packTotal" :key="index">
            <card-test-component v-if="btnIsActive" :pack="pack" />
            <card-test-component v-else :pack="pack" />
        </div>
    </div>
...
import CradTest1 from '../fragments/Carstest1.vue';
